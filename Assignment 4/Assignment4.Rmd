...
## Importing Dataset
```{r}
Pharma <- read.csv("C:/Users/abinaya/Downloads/Pharmaceuticals.csv")
View(Pharma)
```
## Loading Packages
```{r}
...
```{r}
# Question b
#Interpret the clusters in light of the numerical variables that were utilized to create them.
